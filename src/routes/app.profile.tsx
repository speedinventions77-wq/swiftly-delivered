  ...
  return (
    <div className="px-5 pt-6 safe-top">
      <div className="flex items-center gap-3">
        <div className="grid h-14 w-14 place-items-center rounded-full bg-primary text-lg font-bold text-primary-foreground">{(s?.name?.[0] || "U").toUpperCase()}</div>
        <div>
          <p className="font-semibold">{s?.name || "Guest"}</p>
